...
class BalloonController(Node):
    ...
    def rx_callback(self, msg : String):
        ...
        #self.cache_data(msg.data, self.current_time)
        #self.offload_data()
    ...
    def cache_data(self, data, timestamp):
        ...
        #self.get_logger().info(str(timestamp))

    def offload_data(self):
        # Offload all data in the cache to the base station
        for entry in self.cache:
            self.data_publisher.publish(String(data=entry['data']))
