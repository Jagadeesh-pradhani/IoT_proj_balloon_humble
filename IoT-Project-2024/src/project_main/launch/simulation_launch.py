...
rsrc_file = '/home/jagadeesh/IoT-proj/src'
...
def generate_launch_description():
    ...
    targets_to_spawn = [
        IncludeLaunchDescription(
            ...
            launch_arguments={
            'gz_args' : rsrc_file + f"/IoT-Project-2024/resources/{WORLD_NAME}.sdf"
            }.items()
        )
    ]
    ...
    for i in range(NUMBER_OF_BALLOONS):
        targets_to_spawn.append(spawn_sdf(rsrc_file + "/IoT-Project-2024/resources/balloon/balloon.sdf", id = i, pos = (0, i*5, 0)))
    ...
    for i in range(NUMBER_OF_SENSORS):
        targets_to_spawn.append(spawn_sdf(rsrc_file + "/IoT-Project-2024/resources/active_sensor/active_sensor.sdf", id = i, pos = (randint(-40, 40), randint(-40, 40), 0)))
    ...
    #------------------------------------ Spawn base station -------------------------------------
    targets_to_spawn.append(spawn_sdf(rsrc_file + "/IoT-Project-2024/resources/base_station/base_station.sdf", pos = (-5, -5, 0)))
    targets_to_spawn.append(
        Node(
            package="ros_gz_bridge",
            executable="parameter_bridge",
